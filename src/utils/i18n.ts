...
export const translations = {
  ...
  "zh-HK": {
    ...
    evaluatingAudio: "⚡ AI 智能引擎正在分析音訊，維度包括音標、重音與流利度...",
